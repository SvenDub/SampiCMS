...
<html>
	...
	<body>
		<div id="setup">
			...
			<div id="setup_footer">
				<div id="setup_footer_1">1. Welcome</div><div id="setup_footer_2">2. Database</div><div id="setup_footer_3">3. Settings</div><div id="setup_footer_4">4. Users</div><div id="setup_footer_5">5. Done!</div>
			</div>
		</div>
	</body>
</html>