...
<link href="<?php echo REL_ROOT . '/sampi/theme/' . theme . '/global_style.css'; ?>" type="text/css" rel="stylesheet" />
...
?>
<meta name="REL_ROOT" content="<?php echo REL_ROOT; ?>">
<meta name="ADMIN_REL_ROOT" content="<?php echo ADMIN_REL_ROOT; ?>">
</head>
<body>